...
// The middleware updates the passwordChangedAt field of a user document when the "password" is modified (excluding new user creation), typically to track when a user last changed their password.
